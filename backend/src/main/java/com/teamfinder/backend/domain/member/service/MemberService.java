package com.teamfinder.backend.domain.member.service;
...
import com.teamfinder.backend.domain.member.repository.MemberRepository;
...
import com.teamfinder.backend.global.error.exception.EntityNotFoundException;
